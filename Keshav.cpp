...
user *createuser(user*last)
{
    ...
    last=create_user(last,"Rohit","2019");
    last=create_user(last,"Keshav","2026");
    last=create_user(last,"Vivek","2028");
...

{
    ...
    cout<<endl<<endl<<endl;
int k=3*x;
           cout<<setw(22+k)<<"_____"<<endl;
          cout<<setw(24+k)<<"/           \\ "<<endl;
         cout<<setw(24+k)<<"/             \\"<<endl;
 cout<<setw(33+k)<<"__/               \\__ "<<endl;
 cout<<setw(33+k)<<"[   PAISE DE DO HAMARI LE LO    ]"<<endl;
 cout<<setw(33+k)<<"|             GADI              |"<<endl;
 cout<<setw(33+k)<<"|                               |"<<endl;
 cout<<setw(33+k)<<"|__     ___     __|"<<endl;
